...
- [**football-betting-analysis**](https://github.com/JoseArroyave/agent-skills/tree/main/skills/football-betting-analysis): Pre-match football betting analysis in 8 layers. Queries the Bzzoiro API to discover matches, gather odds, team form, H2H history, player stats, and ML predictions, then produces a structured report with probabilistic language. Only analyzes `notstarted` events. No invented data — missing fields are marked `[N/A]`. Confidence levels reflect data availability. Probabilistic language only ("suggests", "could", "signal").
